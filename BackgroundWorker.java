    ...
    protected String doInBackground(String... params) {
        ...
        else if(type.equals("deaddiction motivation"))
        {
            ...
            try {
                ...
                String data_string = URLEncoder.encode("Place_of_Approach", "UTF-8") + "=" + URLEncoder.encode(Approach_Place, "UTF-8") + "&"
                        ...
                        + URLEncoder.encode("Problems_Regarding_Victims_Families", "UTF-8") + "=" + URLEncoder.encode(Family_Approach_Problems, "UTF-8") + "&"
        ...
        else if(type.equals("deaddiction facilitation"))
        {
            ...
            try {
                ...
                String data_string = URLEncoder.encode("Number_of_Victims_Approached_Monthly", "UTF-8") + "=" + URLEncoder.encode(Victims_Approached, "UTF-8") + "&"
                        + URLEncoder.encode("Number_of_Victims_Needed_to_be_Revisited_for_Convincing", "UTF-8") + "=" + URLEncoder.encode(Revisit_Needed, "UTF-8") + "&"
                        + URLEncoder.encode("Number_of_Victims_Linked_to_an_OOAT_Centre", "UTF-8") + "=" + URLEncoder.encode(Linked_To_Centres, "UTF-8") + "&"
                        ...
                        + URLEncoder.encode("Successfully_Treated_Victims", "UTF-8") + "=" + URLEncoder.encode(Successfully_Treated, "UTF-8")+ "&"
                        + URLEncoder.encode("Behavioural_Changes_in_Victims", "UTF-8") + "=" + URLEncoder.encode(Behavioural_Changes , "UTF-8")+ "&"
        ...
        else if(type.equals("vg identification"))
        {
            ...
            try {
                ...
                String data_string = URLEncoder.encode("Number_of_Vulnerable_Groups_Identified", "UTF-8") + "=" + URLEncoder.encode(VulnerableGroups_Identified, "UTF-8") + "&"
                        + URLEncoder.encode("Number_of_Vulnerable_Groups_Counseled", "UTF-8") + "=" + URLEncoder.encode(VulnerableGroups_Counseled, "UTF-8") + "&"
        ...
        else if(type.equals("vg protection"))
        {
            ...
            try {
                ...
                String data_string = URLEncoder.encode("Efforts_Made_for_Protection_of_Vulnerable_Groups", "UTF-8") + "=" + URLEncoder.encode(Efforts_For_Protection, "UTF-8") + "&"
                        + URLEncoder.encode("Activities_Promoted_for_Protection_of_Vulnerable_Groups", "UTF-8") + "=" + URLEncoder.encode(Activities_Promoted, "UTF-8") + "&"
                        + URLEncoder.encode("Vulnerable_Individuals_Linked_to_a_Positive_Activity", "UTF-8") + "=" + URLEncoder.encode(Vulnerable_Individuals_Linked_To_Positive_Activity, "UTF-8") + "&"
